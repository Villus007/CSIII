...
public class WordCount
{
    ...
    {
      if(word.equals("") || counter == null || counter.get(word) == null)
      {
       return 0;  
      }
    ...
    {
        Set<String> distinct = counter.keySet();
        return distinct;
    }
    ...
    {
        int count = 0;
        Map<String, Integer> temp = new ListMap<String, Integer>();  
        String[] coat = text.split(" ");
        for(String c : coat)
        {
            c = sanitize(c);
            if(c.equals(""))
