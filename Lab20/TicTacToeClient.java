...
public class TicTacToeClient extends Client
{
    ...
    public TicTacToeClient() 
    {
    	...
    	connect("localhost", port);			//connect to the server at the specified ip and port
    }
    ...
    public void process(String message)
    {
    	...
    	if("youare".equals(parts[0]))
    	{
    		...
    		TicTacToePiece n = (parts[1].equals("X"))?TicTacToePiece.X:TicTacToePiece.O;
    		game = new TicTacToe();
    		stage = new TicTacToeStage(this , game, n);
